...
### 17.3 進捗の見える化（2026-08-25再集計）

この表は今版のリリース範囲を母数とする。**以後、担当の完了報告ごとに、その施策の「完了した単位」と「状態」を同じ更新で直し、合計と完了率を再計算する。**

**最終数え直し:** 2026-08-25 21:01 JST。`scratchpad/roadmap-recount-report.md` の単位別根拠（実測値又は実施済み検査）に基づく。未コミットの証拠は同報告で明記している。
...
|---|---:|---:|---:|---:|---:|---:|
| 1 提案負荷非依存 | 11～16 | 5 | 3 | 0 | 2 | 0 |
| 2 原子的MoveStep | 5～8 | 3 | 1 | 2 | 0 | 0 |
| 3 30作品corpus | 18～26 | 8 | 1 | 0 | 6 | 1 |
| 4 巨大境界 | 56～82 | 36 | 4 | 0 | 0 | 32 |
| 5 Modal a11y | 9～15 | 6 | 5 | 1 | 0 | 0 |
| 6 bundle | 8～13 | 6 | 4 | 0 | 0 | 2 |
| 7 文書機械検証 | 12～23 | 13 | 3 | 0 | 1 | 9 |
| 8 FOLD 1.2 限定profile | 33～48 | 15 | 1 | 6 | 1 | 7 |
| 9 実利用者（今版の準備） | 6～9 | 3 | 0 | 3 | 0 | 0 |
| 10 supply-chain | 11～17 | 6 | 0 | 1 | 5 | 0 |
| 11 一斉折り案B | 8～12 | 5 | 0 | 5 | 0 | 0 |
| 12 Linux対応 | 0 | 0 | 0 | 0 | 0 | 0 |
| **今版リリース合計** | **177～269** | **106** | **22** | **18** | **15** | **51** |
| 次の版へ繰越: 施策9の外部実施 | 7～12 | 5 | — | — | — | — |

単位ベースの完了率は**22 / 106 = 20.8%**である。人日ベースは、個別見積が明記された完了19単位だけで**30.5～48.0人日**（全体177～269人日に対し確認済み小計**11.3～27.1%**）である。完了済み4-D1〜D3は、4-D全8単位で12～18人日という一括見積しかなく、単位別配分がない。推測による等分を避けるため、22完了単位の厳密な人日完了率は未算出とする。
