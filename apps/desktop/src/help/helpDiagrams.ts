...
const svg = (
  ...
  <defs>
    <marker id="${arrowId}" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
      <path d="M0 0 10 5 0 10Z" fill="#7040c9"/>
    </marker>
  </defs>
  <rect x="8" y="8" width="704" height="264" rx="24" fill="#f5f2ff" stroke="#9f93b8" stroke-width="3"/>
  <g font-family="Yu Gothic UI, Meiryo, sans-serif" fill="#27213d">${drawing(arrowId)}</g>
</svg>`,
  };
};
...
const overviewFlow = svg(
  ...
  (arrow) => `
    <g font-size="14" font-weight="700" text-anchor="middle">
      <g transform="translate(22 55)"><rect width="112" height="116" rx="16" fill="#fff" stroke="#007a70" stroke-width="3"/><rect x="34" y="18" width="44" height="44" rx="4" fill="#ddf8f1" stroke="#007a70" stroke-width="2"/><text x="56" y="88">紙を用意</text></g>
      <g transform="translate(163 55)"><rect width="112" height="116" rx="16" fill="#fff" stroke="#007a70" stroke-width="3"/><rect x="30" y="18" width="52" height="44" rx="3" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M32 56 75 20" stroke="#d43c3c" stroke-width="3"/><path d="M34 26 79 55" stroke="#3b6fc9" stroke-width="3" stroke-dasharray="5 4"/><text x="56" y="88">線を引く</text></g>
      <g transform="translate(304 55)"><rect width="112" height="116" rx="16" fill="#fff" stroke="#007a70" stroke-width="3"/><path d="M25 58 56 18l31 40-31-13Z" fill="#ffd84d" stroke="#7040c9" stroke-width="2" stroke-linejoin="round"/><path d="M56 18v27" stroke="#d43c3c" stroke-width="3"/><text x="56" y="88">折る</text></g>
      <g transform="translate(445 55)"><rect width="112" height="116" rx="16" fill="#fff" stroke="#007a70" stroke-width="3"/><path d="M22 54Q56 8 90 54L56 67Z" fill="#ddf8f1" stroke="#007a70" stroke-width="2"/><path d="M56 21v34M43 34l13-13 13 13" fill="none" stroke="#7040c9" stroke-width="2"/><text x="56" y="88">立体を整える</text></g>
...
const workspaceFourAreas = svg(
  ...
  "画面の4区画",
  "ツールレール、2D展開図、3D表示と手順、下部コンテキストパネルの位置",
  () => `
    ...
    <rect x="42" y="70" width="58" height="142" rx="8" fill="#fff5c2" stroke="#ffd84d" stroke-width="2"/><text x="71" y="109" font-size="12" font-weight="700" text-anchor="middle"><tspan x="71">①</tspan><tspan x="71" dy="22">道具</tspan><tspan x="71" dy="18">レール</tspan></text>
    <rect x="106" y="70" width="238" height="142" rx="8" fill="#ddf8f1" stroke="#007a70" stroke-width="2"/><text x="124" y="92" font-size="14" font-weight="700">② 2D 展開図</text><rect x="160" y="106" width="126" height="82" fill="#fff" stroke="#9f93b8"/><path d="M160 188 286 106M160 106l126 82" stroke="#d43c3c" stroke-width="3"/><path d="M223 106v82" stroke="#3b6fc9" stroke-width="3" stroke-dasharray="6 4"/>
    <rect x="350" y="70" width="328" height="105" rx="8" fill="#eee7ff" stroke="#7040c9" stroke-width="2"/><text x="368" y="92" font-size="14" font-weight="700">③ 立体表示</text><path d="M468 152 521 94l64 57-54-18Z" fill="#fff5c2" stroke="#7040c9" stroke-width="3"/><path d="M521 94l10 39" stroke="#d43c3c" stroke-width="3"/>
    <rect x="350" y="181" width="328" height="31" rx="8" fill="#fff" stroke="#7040c9" stroke-width="2"/><text x="367" y="201" font-size="12" font-weight="700">手順タイムライン</text><g fill="#ddf8f1" stroke="#007a70"><rect x="520" y="188" width="28" height="17" rx="7"/><rect x="554" y="188" width="28" height="17" rx="7"/><rect x="588" y="188" width="28" height="17" rx="7"/></g>
    <rect x="42" y="219" width="636" height="28" rx="8" fill="#ffe8ed" stroke="#ed5c70" stroke-width="2"/><text x="58" y="238" font-size="13" font-weight="700">④ 下部コンテキストパネル — 今できる操作と選んだものの設定</text>`,
);
...
const newPaperSettings = svg(
  ...
  (arrow) => `
    ...
    <g transform="translate(330 45)"><text x="0" y="0" font-size="14" font-weight="700">紙の表・紙の裏：24色</text>
      ...
      </g><circle cx="18" cy="70" r="17" fill="none" stroke="#7040c9" stroke-width="4"/><path d="m10 70 6 6 11-14" fill="none" stroke="#27213d" stroke-width="3" stroke-linecap="round"/>
...
const creaseTools = svg(
  ...
  () => `
    <rect x="42" y="31" width="408" height="218" rx="7" fill="#fff" stroke="#27213d" stroke-width="3"/>
    ...
    <path d="M68 54 419 213" stroke="#3b6fc9" stroke-width="5" stroke-dasharray="10 7"/><text x="376" y="195" font-size="13" font-weight="700" fill="#3b6fc9">谷</text>
    <path d="M78 139h345" stroke="#007a70" stroke-width="3" stroke-dasharray="3 6"/><text x="370" y="132" font-size="12" fill="#005e56">補助</text>
    ...
    <circle cx="246" cy="139" r="10" fill="#ffd84d" stroke="#7040c9" stroke-width="3"/><path d="M239 139h14M246 132v14" stroke="#27213d" stroke-width="2"/><text x="263" y="158" font-size="12" font-weight="700">吸着</text>
...
const foldFlow = svg(
  ...
  (arrow) => `
    <g font-size="13" font-weight="700" text-anchor="middle">
      <g transform="translate(25 43)"><rect width="196" height="190" rx="18" fill="#fff" stroke="#007a70" stroke-width="3"/><circle cx="26" cy="27" r="17" fill="#007a70"/><text x="26" y="32" fill="#fff">1</text><text x="98" y="31">折り線を引く</text><rect x="42" y="55" width="112" height="96" fill="#ddf8f1" stroke="#27213d" stroke-width="2"/><path d="M49 139 148 65" stroke="#3b6fc9" stroke-width="4" stroke-dasharray="7 5"/><path d="M66 128 128 81" stroke="#7040c9" stroke-width="3" marker-end="url(#${arrow})"/><text x="98" y="175" font-size="11">3Dは Ctrl + ドラッグ</text></g>
      <g transform="translate(262 43)"><rect width="196" height="190" rx="18" fill="#fff" stroke="#007a70" stroke-width="3"/><circle cx="26" cy="27" r="17" fill="#007a70"/><text x="26" y="32" fill="#fff">2</text><text x="98" y="31">向きと紙を選ぶ</text><path d="M38 145 98 59l60 86-60-25Z" fill="#ffd84d" stroke="#27213d" stroke-width="2"/><path d="M98 59v61" stroke="#d43c3c" stroke-width="4"/><path d="M133 72q30 30 2 62" fill="none" stroke="#7040c9" stroke-width="3" marker-end="url(#${arrow})"/><g transform="translate(51 157)"><rect x="0" y="8" width="50" height="8" rx="4" fill="#eee7ff"/><rect x="4" y="4" width="50" height="8" rx="4" fill="#ddf8f1"/><rect x="8" width="50" height="8" rx="4" fill="#ffd84d"/></g><text x="136" y="174" font-size="11">対象の層</text></g>
      <g transform="translate(499 43)"><rect width="196" height="190" rx="18" fill="#fff" stroke="#007a70" stroke-width="3"/><circle cx="26" cy="27" r="17" fill="#007a70"/><text x="26" y="32" fill="#fff">3</text><text x="104" y="31">折って確認</text><path d="M32 143 94 57l72 83-68-24Z" fill="#ddf8f1" stroke="#27213d" stroke-width="2"/><path d="M94 57 98 116" stroke="#3b6fc9" stroke-width="4"/><path d="M56 119q45-38 91 5" fill="none" stroke="#ed8a2b" stroke-width="5" stroke-dasharray="7 5"/><rect x="28" y="157" width="142" height="25" rx="12" fill="#fff5c2"/><text x="99" y="174" font-size="10">巻き込みの追加折り目</text></g>
    </g>
...
const threeDimensionalControls = svg(
  ...
  (arrow) => `
    <g font-size="12" font-weight="700" text-anchor="middle">
      ...
      <g transform="translate(32 176)"><rect width="165" height="72" rx="16" fill="#fff" stroke="#007a70" stroke-width="2"/><text x="82" y="22">ふくらます</text><ellipse cx="82" cy="52" rx="37" ry="14" fill="#ddf8f1" stroke="#007a70" stroke-width="3"/><path d="M82 49V30M50 49 34 38M114 49l16-11" stroke="#7040c9" stroke-width="2" marker-end="url(#${arrow})"/></g>
      <g transform="translate(523 176)"><rect width="165" height="72" rx="16" fill="#fff" stroke="#ed5c70" stroke-width="2"/><text x="82" y="22">重なり防止</text><path d="M39 60 93 35l38 18-54 17Z" fill="#eee7ff" stroke="#7040c9"/><path d="M34 50 88 25l38 18-54 17Z" fill="#ffd84d" stroke="#27213d"/><path d="M137 30v29M128 45h18" stroke="#ed5c70" stroke-width="4"/></g>
    </g>
    <g transform="translate(244 62)"><path d="M18 124 111 17l121 113-111-39Z" fill="#ddf8f1" stroke="#27213d" stroke-width="3"/><path d="M111 17 121 91M18 124l103-33 111 39" fill="none" stroke="#7040c9" stroke-width="3"/><g stroke="#9f93b8" stroke-width="1"><path d="M54 83l100 20M77 56l107 58M94 37l119 82"/><path d="M61 109 131 36M91 114l66-55M124 123l61-36"/></g><path d="M121 91q-5-40-10-74" fill="none" stroke="#007a70" stroke-width="4"/></g>
...
const techniqueCards = svg(
  "technique-cards",
  "8つの技法",
  "段折りからねじり折りまで8種類の技法の一覧",
  () => `
    <g font-size="12" font-weight="700" text-anchor="middle">
      <g transform="translate(24 34)"><rect width="158" height="92" rx="15" fill="#fff5c2" stroke="#ffd84d" stroke-width="4"/><path d="M35 58h88" stroke="#d43c3c" stroke-width="4"/><path d="M35 70h88" stroke="#3b6fc9" stroke-width="4" stroke-dasharray="7 4"/><text x="79" y="23">段折り</text></g>
      <g transform="translate(195 34)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M42 70 79 34l37 36-37-15Z" fill="#ddf8f1" stroke="#27213d"/><path d="M79 34v34" stroke="#7040c9" stroke-width="3"/><text x="79" y="23">中割り折り</text></g>
      <g transform="translate(366 34)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M40 69 79 35l39 34-39-13Z" fill="#eee7ff" stroke="#27213d"/><path d="M51 52q27-28 56 2" fill="none" stroke="#7040c9" stroke-width="3"/><text x="79" y="23">かぶせ折り</text></g>
      <g transform="translate(537 34)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M39 72 79 36l40 36-40-17Z" fill="#ddf8f1" stroke="#27213d"/><path d="M79 36v36" stroke="#d43c3c" stroke-width="3"/><text x="79" y="23">花弁折り</text></g>
      <g transform="translate(24 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M79 34 38 70h82Z" fill="#ddf8f1" stroke="#27213d"/><path d="M79 39 51 67M79 39l28 28" stroke="#7040c9" stroke-width="3"/><text x="79" y="23">開いてつぶす</text></g>
      <g transform="translate(195 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M42 70 79 34l37 36Z" fill="#eee7ff" stroke="#27213d"/><path d="M79 37v25" stroke="#ed5c70" stroke-width="4"/><path d="m72 55 7 10 7-10" fill="#ed5c70"/><text x="79" y="23">沈め折り</text></g>
      <g transform="translate(366 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M37 69q42-40 84 0M48 69q31-26 62 0" fill="none" stroke="#7040c9" stroke-width="4"/><text x="79" y="23">ひだ寄せ</text></g>
      <g transform="translate(537 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="m79 34 29 20-11 34H61L50 54Z" fill="#ffd84d" stroke="#27213d" stroke-width="2"/><path d="M79 34q30 10 22 39" fill="none" stroke="#7040c9" stroke-width="3"/><path d="m96 66 6 9 6-8" fill="#7040c9"/><text x="79" y="23">ねじり折り</text></g>
    </g>`,
);
...
const timelineFlow = svg(
  ...
  (arrow) => `
    <g transform="translate(58 39)"><path d="M20 54 55 20l35 34-35-13Z" fill="#fff" stroke="#27213d"/><path d="M158 54 193 20l35 34-35-13Z" fill="#ddf8f1" stroke="#27213d"/><path d="M296 54 331 20l35 34-35-13Z" fill="#fff5c2" stroke="#27213d"/><path d="M434 54 469 20l35 34-35-13Z" fill="#eee7ff" stroke="#27213d"/></g>
    <path d="M61 168h598" stroke="#9f93b8" stroke-width="6" stroke-linecap="round"/>
    <g font-size="12" font-weight="700" text-anchor="middle"><g transform="translate(48 140)"><rect width="104" height="57" rx="14" fill="#fff" stroke="#9f93b8" stroke-width="2"/><text x="52" y="34">1 山折り</text></g><g transform="translate(181 140)"><rect width="104" height="57" rx="14" fill="#eee7ff" stroke="#7040c9" stroke-width="4"/><text x="52" y="34">2 中割り</text></g><g transform="translate(430 140)"><rect width="104" height="57" rx="14" fill="#fff" stroke="#9f93b8" stroke-width="2"/><text x="52" y="34">3 角度</text></g><g transform="translate(563 140)"><rect width="104" height="57" rx="14" fill="#fff" stroke="#9f93b8" stroke-width="2"/><text x="52" y="34">4 仕上げ</text></g></g>
    ...
    <g transform="translate(58 224)"><circle cx="22" cy="15" r="15" fill="#007a70"/><path d="m18 8 12 7-12 7Z" fill="#fff"/><text x="48" y="20" font-size="13" font-weight="700">自動再生</text><path d="M128 15h100" stroke="#7040c9" stroke-width="3" marker-end="url(#${arrow})"/><text x="245" y="20" font-size="12">手順を順番に折る</text></g>`,
);
...
const troubleshootingFlow = svg(
  ...
  (arrow) => `
    ...
    <g transform="translate(468 25)"><rect width="213" height="78" rx="17" fill="#fff5c2" stroke="#ffd84d" stroke-width="3"/><text x="106" y="23" font-size="13" font-weight="700" text-anchor="middle">追加折り目を確認</text><rect x="48" y="34" width="116" height="31" fill="#fff" stroke="#27213d"/><path d="M51 62q56-42 110 0" fill="none" stroke="#ed8a2b" stroke-width="4" stroke-dasharray="7 5"/></g>
    ...
    <circle cx="692" cy="139" r="17" fill="#007a70"/><path d="m684 139 6 6 11-14" fill="none" stroke="#fff" stroke-width="4"/><text x="656" y="145" font-size="12" font-weight="700" text-anchor="end">直して続ける</text>`,
);
