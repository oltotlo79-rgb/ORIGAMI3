...
const workspaceFourAreas = svg(
  ...
  () => `
    ...
    <rect x="106" y="70" width="238" height="142" rx="8" fill="#ddf8f1" stroke="#007a70" stroke-width="2"/><text x="124" y="92" font-size="14" font-weight="700">② 2D 展開図</text><rect x="160" y="106" width="126" height="82" data-help-paper fill="#fff" stroke="#9f93b8"/><path d="M160 188 286 106M160 106l126 82" stroke="#d43c3c" stroke-width="3"/><path d="M223 106v82" stroke="#3b6fc9" stroke-width="3" stroke-dasharray="6 4"/>
    <rect x="350" y="70" width="328" height="105" rx="8" fill="#eee7ff" stroke="#7040c9" stroke-width="2"/><text x="368" y="92" font-size="14" font-weight="700">③ 立体表示</text><path d="M468 152 521 94l64 57-54-18Z" data-help-paper fill="#fff5c2" stroke="#7040c9" stroke-width="3"/><path d="M521 94l10 39" stroke="#d43c3c" stroke-width="3"/>
...
const techniqueCards = svg(
  ...
  () => `
    <g font-size="12" font-weight="700" text-anchor="middle">
      ...
      <g transform="translate(195 34)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M42 70 79 34l37 36-37-15Z" data-help-paper fill="#ddf8f1" stroke="#27213d"/><path d="M79 34v34" stroke="#7040c9" stroke-width="3"/><text x="79" y="23">中割り折り</text></g>
      <g transform="translate(366 34)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M40 69 79 35l39 34-39-13Z" data-help-paper fill="#eee7ff" stroke="#27213d"/><path d="M51 52q27-28 56 2" fill="none" stroke="#7040c9" stroke-width="3"/><text x="79" y="23">かぶせ折り</text></g>
      <g transform="translate(537 34)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M39 72 79 36l40 36-40-17Z" data-help-paper fill="#ddf8f1" stroke="#27213d"/><path d="M79 36v36" stroke="#d43c3c" stroke-width="3"/><text x="79" y="23">花弁折り</text></g>
      <g transform="translate(24 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M79 34 38 70h82Z" data-help-paper fill="#ddf8f1" stroke="#27213d"/><path d="M79 39 51 67M79 39l28 28" stroke="#7040c9" stroke-width="3"/><text x="79" y="23">開いてつぶす</text></g>
      <g transform="translate(195 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="M42 70 79 34l37 36Z" data-help-paper fill="#eee7ff" stroke="#27213d"/><path d="M79 37v25" stroke="#ed5c70" stroke-width="4"/><path d="m72 55 7 10 7-10" fill="#ed5c70"/><text x="79" y="23">沈め折り</text></g>
      ...
      <g transform="translate(537 151)"><rect width="158" height="92" rx="15" fill="#fff" stroke="#9f93b8" stroke-width="2"/><path d="m79 34 29 20-11 34H61L50 54Z" data-help-paper fill="#ffd84d" stroke="#27213d" stroke-width="2"/><path d="M79 34q30 10 22 39" fill="none" stroke="#7040c9" stroke-width="3"/><path d="m96 66 6 9 6-8" fill="#7040c9"/><text x="79" y="23">ねじり折り</text></g>
    </g>`,
);
