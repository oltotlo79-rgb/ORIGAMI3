    ...
    const issues: FoldIssue[] = [
      {
        ...
        message:
          "FOLD 1.2 parser schema validator パーサ スキーマ バリデータ Aux raw-message",
        original_value: { sentinel: "raw-value", pathName: "JSON path" },
      },
      {
        severity: "warning",
        code: "unsupported_field",
        ...
        message:
          "FOLD 1.1 parser schema validator パーサ スキーマ バリデータ Aux raw-message-2",
