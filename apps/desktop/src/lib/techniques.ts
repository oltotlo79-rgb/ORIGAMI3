...
export const SUPPORTED_TECHNIQUES: {
  ...
  },
  {
    ...
    short: "ひだ寄せ",
    title:
      "ひだ寄せ: 紙の縁を支点のまわりに寄せ、余った紙をひだにします。寄せたい縁が乗っている基準線をドラッグし、基準点で寄せる先を指してください",
  },
  {
    kind: "Twist",
    short: "ねじり",
    title:
      "ねじり折り: 中央の多角形を回し、周りにひだを作ります。中央の形の角を順にクリックしてください(3つ以上。辺の数も長さも自由)。Ctrl+クリックで中心、Backspaceで1つ戻す。1辺をドラッグすると正多角形になります",
  },
];
